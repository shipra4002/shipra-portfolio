...
export function WorkSection() {
  return (
    <section id="work" className="scroll-mt-24 px-3 md:px-6">
      <div className="relative mx-auto max-w-[1400px] overflow-hidden rounded-[36px] bg-linear-to-br from-work-gold-start via-work-gold-mid to-work-gold-end text-[#F3F0E8] shadow-[0_40px_80px_-40px_rgba(0,0,0,0.8)] md:rounded-[48px]">
        <div className="relative mx-auto max-w-6xl px-6 py-24 md:px-14 md:py-32">
        <Reveal className="max-w-3xl">
          <span className="text-xs uppercase tracking-[0.28em] text-work-gold-ink">Selected Work</span>
